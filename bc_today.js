"use strict";// Step 4 Sets browser to assume Strict usage which treats syntax errors as runtine and loadtime.
/*
...
*/
//Step 5 Creates and sets thisDate variable. This will be used to test dates before finally setting it to current day. NJS
var thisDate = new Date();

//Step 6 Create the dateString variable and converts the thisDate variable into a readable string format using locale conventions. NJS
var dateString = thisDate.toLocaleDateString();
//Step 7 Create the dateHtml variable 
var dateHtml = "<h2>" + dateString + "</h2>";
//Step 8 Creates the thisDay variable which will be used to get the daye of the week. NJS
var thisDay = thisDate.getDay();
//Step 9Creates the eventHTML variable which calls the getEvent function which returns the information based on the day of the week. NJS
var eventHTML = getEvent(thisDay);

//Step 10 uses the insertAdjacentHTML to insert a text as HTML into the unionToday.  NJS 
